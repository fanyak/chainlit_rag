              ...
              <CardContent className="tips-content">
                <ul>
                  <li>
                    ...
                    ενοίκια για το {new Date().getFullYear() - 1}».
                  </li>
                  <li>
                    <strong>Διαχειριστείτε τα token σας:</strong> Κάθε ερώτημα
                    χρεώνεται με βάση τα tokens που καταναλώνονται συν €0,01
                    πάγιο κόστος. Μην κάνετε ερωτήσεις που δεν αφορούν στην
                    ελληνική νομοθεσία. Το μοντέλο AI έχει οδηγίες να απαντά
                    μόνο σε φορολογικά ερωτήματα!
                  </li>
                  {/* <li>
