            ...
            <div className="steps-grid">
              ...
              <Card className="step-card featured">
                ...
                <CardContent>
                  ...
                  <p className="mt-3">
                    Ανακτώνται έως και <strong>15 σχετικά αποσπάσματα</strong>{' '}
            ...
            <Card>
              <CardContent className="tips-content">
                <ul>
                  ...
                  <li>
                    <strong>Διαχειριστείτε τα token σας:</strong> Μην κάνετε
                    ερωτήσεις που δεν αφορούν στην ελληνική νομοθεσία. Το
                    μοντέλο AI έχει οδηγίες να απαντά μόνο σε φορολογικά
                    ερωτήματα!
                  </li>
                  {/* <li>
