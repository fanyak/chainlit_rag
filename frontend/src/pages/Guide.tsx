            ...
            <div className="steps-grid">
              ...
              <Card className="step-card featured">
                ...
                <CardContent>
                  ...
                  <p className="mt-3">
                    Ανακτώνται <strong>σχετικά αποσπάσματα</strong> από νόμους,
                    εγκυκλίους και αποφάσεις.
                  </p>
                </CardContent>
              </Card>
              ...
              <CardContent className="tips-content">
                <ul>
                  <li>
                    ...
                    φορολογούμαι», δώστε περισσότερες πληροφορίες όπως: «πώς
                    φορολογούμαι για εισοδήματα από ενοίκια το{' '}
                    {new Date().getFullYear() - 1}».
                  </li>
                  <li>
                    <strong>Διαχειριστείτε τα token σας:</strong> Κάθε ερώτημα
                    χρεώνεται με βάση τα tokens που καταναλώνονται για την
                    απάντηση, συν το πάγιο κόστος για λειτουργικά έξοδα.{' '}
                    <b>
                      Μην κάνετε ερωτήσεις που δεν αφορούν στην ελληνική
                      νομοθεσία
                    </b>
                    . Το μοντέλο AI έχει οδηγίες να κάνει αναζήτηση μόνο σε
                    έγγραφα της ΑΑΔΕ! <br />
                    <small>
                      Μια ερώτηση άσχετη με τη νομοθεσία θα χρεωθεί για τη
                      λειτουργία του μοντέλου, αλλά δεν θα λάβετε σωστή
                      απάντηση.
                    </small>
                  </li>
                  {/* <li>
                  ...
                  <li>
                    <strong>Κάντε μία ερώτηση τη φορά σε καθε μήνυμα:</strong>{' '}
                    Για πιο ακριβείς απαντήσεις, αποφύγετε τις πολλαπλές
                    ερωτήσεις σε ένα μήνυμα.
                  </li>
                  <li>
                    <strong>Ζητήστε διευκρινίσεις:</strong> Αν η απάντηση δεν
                    είναι πλήρης, μη διστάσετε να ρωτήσετε για περισσότερες
                    λεπτομέρειες στην ίδια συνομιλία.
                  </li>
                  <li>
                    <strong>
                      Ξεκινήστε νέα συνομιλία για κάθε νέο θέμα συζήτησης:
                    </strong>{' '}
                    Αν μια ερώτηση και οι διευκρινιστικές απαντήθηκαν, τότε
                    ξεκινήστε νέα συνομιλία για νέο θέμα. Αν στην ίδια συνομιλία
                    κάνετε ερωτήσεις για διαφορετικά θέματα, τότε σπαταλάτε
                    tokens για να διατηρείτε διαφορετικά δεδομένα στην ίδια
                    συνομιλία και υπάρχει μεγαλύτερη πιθανότητα η επίδοση του
                    bot να μειωθεί.
                  </li>
                </ul>
              </CardContent>
