        ...
        <div className="features" aria-hidden="false">
          <div className="card card--left" aria-labelledby="features-title">
            ...
            <ul className="features-list" role="list">
              <li role="listitem">
                Εξελιγμένη αναζήτηση στη βιβλιοθήκη εγγράφων της ΑΑΔΕ, όχι στη
              ...
              <li role="listitem">
                Παροχή απαντήσεων με συγκεκριμένες αναφορές σε άρθρα νόμων και
                εγκυκλίων.
                <span className="meta">
                  Links προς τα έγγραφα στη βιβλιοθήκη της ΑΑΔΕ.
                </span>
              </li>
            </ul>
          </div>
