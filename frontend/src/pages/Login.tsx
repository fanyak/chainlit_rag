        ...
        <div className="features" aria-hidden="false">
          <div className="card card--left" aria-labelledby="features-title">
            ...
            <ul className="features-list" role="list">
              <li role="listitem">
                Το Foros chat <strong>αναζητά στη βιβλιοθήκη της ΑΑΔΕ</strong>{' '}
                τα έγγραφα που απαντούν καλύτερα την ερώτησή σας, τα συνθέτει
                και σας προσφέρει μια πλήρη και τεκμηριωμένη απάντηση.
                <span className="meta">
                  Γίνεται υβριδική αναζήτηση (σημασιολογική + λέξεις-κλειδιά) σε
                  χιλιάδες νόμους, εγκυκλίους και αποφάσεις.
                </span>
              </li>
              <li role="listitem">
                Διαθέτει λειτουργία «<strong>βελτιστοποίησης ερώτησης</strong>»:
                δημιουργεί πολλαπλές παραλλαγές της ερώτησης για ακριβέστερη
                ανάκτηση των σχετικών εγγράφων.
                <span className="meta">
                  Αυτόματη δημιουργία 5 παραλλαγών της ερώτησης και αντίστοιχη
                  αναζήτηση στη βιβλιοθήκη της ΑΑΔΕ.
                </span>
              </li>
              <li role="listitem">
                Εφαρμόζει{' '}
                <strong>έξυπνη κατάταξη των ανακτημένων εγγράφων</strong> -
                επιλογή των 10 πιο σχετικών και πρόσφατων από τα συνολικά
                αποτελέσματα.
                <span className="meta">
                  Reranking με ξεχωριστό, εξειδικευμένο μοντέλο AI για υψηλή
                  ακρίβεια.
                </span>
              </li>
              <li role="listitem">
                Παρέχει απαντήσεις με <strong>συγκεκριμένες αναφορές</strong> σε
                άρθρα νόμων και εγκυκλίων.
                <span className="meta">
                  Το Foros chat προσφέρει Links προς τα έγγραφα της βιβλιοθήκης
                  της ΑΑΔΕ που χρησιμοποίησε για την σύνθεση της απάντησης.
                </span>
              </li>
            </ul>
          </div>
